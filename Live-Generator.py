...
time.sleep(1.2)
print("")
print("\033[1;36m  📲si lo puedes imaginar💻")
print("")
time.sleep(1.6)
print("        📲lo pudes programar💻")
print("")
time.sleep(2.2)
...
def usage():
    ...
    print("")
    print("\033[1;33m     python2 Live-Generator.py -b     [Opciones de uso]")
    print("     python2 Live-Generator.py -h     Mensaje de ayuda")
    print("")
    print("+\033[;35m Opciones de uso\033[1;31m +")
    print("")
    print("\033[1;35m     -b, -bin       Formato de bin")
    print("     -u, -cantidad  tarjetas a generar")
    ...
    print("")
    print("   \033[1;33mB¡ทℯℛℴ₄1�7 ð℄1�7 ☪ℴℛα☡óค1�7 ƴ ℳα₷\033[1;31m")
    print("        \033[1;37m☬✞๔єאtєг➊➒➒➒✞☬")
#Arg parser
